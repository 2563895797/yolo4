...
def fit_one_epoch(net, yolo_loss, epoch, epoch_size,
                  epoch_size_val, gen, genval, Epoch, cuda):
    if Tensorboard:
...
if __name__ == "__main__":
    ...
    yolo_loss = YOLOLoss(np.reshape(anchors, [-1, 2]), num_classes, (input_shape[1], input_shape[0]), smooth_label,
                         Cuda, normalize)
